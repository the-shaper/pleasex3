            ...
            >
                ...
                <div className="flex gap-3 justify-end">
                    <button
                        ...
                        className="px-4 py-2 bg-greenlite text-gray-700 font-medium hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        Keep Ticket
                    </button>
                    <button
                        onClick={onConfirm}
                        disabled={isSubmitting}
                        className="px-4 py-2 bg-text text-coral font-medium hover:bg-red-700 hover:text-bg transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isSubmitting ? (
                            <>
