          ...
          <div className="space-y-6">
            ...
            {ticket && (
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                {ticket.status === "open" && (
                  <p className=" bg-text px-3 py-2 text-sm text-text-bright uppercase">
                    {ticket.creatorSlug || "This creator"} hasn't yet reviewed
                    your request. We will notify you via e-mail once this has
                    been done.
                  </p>
                )}
                ...
                {ticket.status === "approved" && queueData && (
                  <div className="bg-gray-subtle p-4 border border-text">
                    ...
                    <div
                      className="flex gap-6 text-xs text-text"
