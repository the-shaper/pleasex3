...
const meta = {
    ...
    argTypes: {
        queueSnapshot: {
            control: "object",
            description: "Snapshot of the current queue state with metrics for personal and priority queues",
        },
        toggleQueue: {
            action: "toggleQueue",
...
const mockToggleQueue = async (args: { creatorSlug: string; kind: "personal" | "priority" }) => {
