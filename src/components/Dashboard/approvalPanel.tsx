  ...
  return (
    <div className="h-full flex flex-col justify-center">
      <div className="flex-1 space-y-6 overflow-y-auto no-scrollbar">
        {tickets.map((ticket) => {
          const queueKind =
            ticket.queueKind === "priority" ? "priority" : "personal";
          ...
          const ticketData = {
            ...
            queueMetrics: {
              personal: {
                etaMins: queueSnapshot.personal.etaDays
                  ? queueSnapshot.personal.etaDays * 24 * 60
                  : 0,
              },
              priority: {
                etaMins: queueSnapshot.priority.etaDays
                  ? queueSnapshot.priority.etaDays * 24 * 60
                  : 0,
              },
            },
            userName: "Alejandro",
