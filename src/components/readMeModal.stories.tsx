...
const meta: Meta<typeof ReadMeModal> = {
    title: "Components/ReadMeModal",
...
type Story = StoryObj<typeof ReadMeModal>;
    ...
    return (
        <div className="min-h-screen bg-bg p-8">
            <div className="max-w-2xl mx-auto space-y-4">
                <h1 className="text-4xl font-bold text-text mb-4">FAQ Modal Demo</h1>
                <p className="text-text-muted mb-8">
                    Click the button below to open the FAQ modal and view the user-friendly
                    help content.
                </p>
    ...
    return (
        <div className="min-h-screen bg-bg p-8">
            <p className="text-text-muted mb-4 text-center">
                The modal content is scrollable - try scrolling through the FAQ
            </p>
            <ReadMeModal isOpen={isOpen} onClose={() => setIsOpen(false)} />
        </div>
    );
