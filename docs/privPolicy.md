...
| ----------- | --------------------------------- | -------------------------------------------------------------------------------------- |
| **Clerk**   | Authentication                    | Email address, name, hashed passwords, and social login tokens                         |
| **Stripe**  | Payments & Payouts                | Credit card data, bank account information, tax identifiers                            |
| **Convex**  | Database & Backend Infrastructure | Ticket content, user IDs, queue positions, timestamps                                  |
| **Resend**  | Transactional Email               | Email address and notification content                                                 |
| **PostHog** | Product Analytics                 | Page views, click events, device and browser information, IP address, session metadata |
