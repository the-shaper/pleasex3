...
interface TicketRejectedEmailProps {
  ...
  ticketRef: string;
  creatorName: string;
  reason?: "creator_rejected" | "expired";
}
...
export const TicketRejectedEmail = ({
  ...
  const reasonText = isExpired
    ? `Your request was not reviewed within the required timeframe and has automatically expired.`
    : `Unfortunately, your request could not be accepted at this time.`;
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            {reasonText} (Request <strong>{ticketRef}</strong> for{" "}
