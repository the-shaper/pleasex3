...
const ModalWrapper = ({ Component, title, label }: { Component: any, title: string, label: string }) => {
...
export const About: StoryObj<typeof AboutModal> = {
    render: () => <ModalWrapper Component={AboutModal} title="About Modal" label="Open About Modal" />,
};

// --- Privacy Modal ---
export const Privacy: StoryObj<typeof PrivacyModal> = {
    render: () => <ModalWrapper Component={PrivacyModal} title="Privacy Policy Modal" label="Open Privacy Policy" />,
};

// --- Terms of Service Modal ---
export const TermsOfService: StoryObj<typeof TosModal> = {
    render: () => <ModalWrapper Component={TosModal} title="Terms of Service Modal" label="Open ToS" />,
};

// --- Read Me Modal ---
export const ReadMe: StoryObj<typeof ReadMeModal> = {
    render: () => <ModalWrapper Component={ReadMeModal} title="Read Me / Cheatsheet Modal" label="Open ReadMe" />,
};
